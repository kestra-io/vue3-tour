import { ref, computed, onMounted, getCurrentInstance, onBeforeUnmount, resolveComponent, openBlock, createElementBlock, renderSlot, createBlock, createCommentVNode, onUnmounted, normalizeClass, createElementVNode, withModifiers, toDisplayString } from "vue";
...
const _sfc_main = {
  ...
  setup(props2, context) {
    ...
    const createHighlight = () => {
      const highlightElement = document.querySelector(props2.step.highlightElement) ? document.querySelector(props2.step.highlightElement) : targetElement;
...
const _hoisted_6 = { class: "v-step__buttons" };
...
var VStep = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-3d60baca"]]);
const install = (app) => {
